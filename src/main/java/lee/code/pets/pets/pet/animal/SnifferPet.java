...
public class SnifferPet extends Sniffer {

  public SnifferPet(Player player, boolean baby, String name) {
    super(EntityType.SNIFFER, ((CraftWorld) player.getLocation().getWorld()).getHandle());
