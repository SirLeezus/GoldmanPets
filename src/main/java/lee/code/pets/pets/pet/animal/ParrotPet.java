...
public class ParrotPet extends Parrot {

  public ParrotPet(Player player, String[] data) {
    super(EntityType.PARROT, ((CraftWorld) player.getLocation().getWorld()).getHandle());
    ...
    setVariant(Variant.valueOf(data[2]));
