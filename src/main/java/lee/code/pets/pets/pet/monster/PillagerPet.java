...
public class PillagerPet extends Mob {
  public PillagerPet(Player player, String[] data) {
    super(EntityType.PILLAGER, ((CraftWorld) player.getLocation().getWorld()).getHandle());
