...
public class ZombieHorsePet extends ZombieHorse {

  public ZombieHorsePet(Player player, boolean baby, boolean saddle, String name) {
    super(EntityType.ZOMBIE_HORSE, ((CraftWorld) player.getLocation().getWorld()).getHandle());
