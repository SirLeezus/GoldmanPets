...
public class BreezePet extends Breeze {

  public BreezePet(Player player, String[] data) {
    super(EntityType.BREEZE, ((CraftWorld) player.getLocation().getWorld()).getHandle());
