...
public class MushroomCowPet extends MushroomCow {

  public MushroomCowPet(Player player, boolean baby, String name, String type) {
    super(EntityType.MOOSHROOM, ((CraftWorld) player.getLocation().getWorld()).getHandle());
