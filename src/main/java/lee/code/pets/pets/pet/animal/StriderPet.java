...
public class StriderPet extends Strider {

  public StriderPet(Player player, boolean baby, String name) {
    super(EntityType.STRIDER, ((CraftWorld) player.getLocation().getWorld()).getHandle());
