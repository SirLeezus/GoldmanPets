...
public class IronGolemPet extends IronGolem {

  public IronGolemPet(Player player, String[] data) {
    super(EntityType.IRON_GOLEM, ((CraftWorld) player.getLocation().getWorld()).getHandle());
