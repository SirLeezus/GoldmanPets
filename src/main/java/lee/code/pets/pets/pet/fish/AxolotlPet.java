...
public class AxolotlPet extends Axolotl {

  public AxolotlPet(Player player, boolean baby, String name, String variant) {
    super(EntityType.AXOLOTL, ((CraftWorld) player.getLocation().getWorld()).getHandle());
