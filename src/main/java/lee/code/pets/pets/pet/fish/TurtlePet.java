...
public class TurtlePet extends Turtle {

  public TurtlePet(Player player, boolean baby, String name) {
    super(EntityType.TURTLE, ((CraftWorld) player.getLocation().getWorld()).getHandle());
