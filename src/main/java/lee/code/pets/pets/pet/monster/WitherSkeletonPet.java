...
public class WitherSkeletonPet extends Mob {

  public WitherSkeletonPet(Player player, String[] data) {
    super(EntityType.WITHER_SKELETON, ((CraftWorld) player.getLocation().getWorld()).getHandle());
