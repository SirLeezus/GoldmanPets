...
public class VindicatorPet extends Mob {

  public VindicatorPet(Player player, String name) {
    super(EntityType.VINDICATOR, ((CraftWorld) player.getLocation().getWorld()).getHandle());
