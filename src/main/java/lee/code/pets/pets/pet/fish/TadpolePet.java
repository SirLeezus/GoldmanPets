...
public class TadpolePet extends Tadpole {

  public TadpolePet(Player player, String[] data) {
    super(EntityType.TADPOLE, ((CraftWorld) player.getLocation().getWorld()).getHandle());
