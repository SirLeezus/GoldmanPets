...
public class PetDataUtil {
  ...
  public static String serializePetData(Entity entity) {
    ...
    switch (entityType) {
      case ALLAY, BAT, IRON_GOLEM, WANDERING_TRADER, COD, DOLPHIN, ELDER_GUARDIAN, GLOW_SQUID, GUARDIAN, PUFFERFISH, SALMON, SQUID, TADPOLE, CAVE_SPIDER, ENDERMAN, EVOKER, GHAST, ILLUSIONER, PHANTOM, PIGLIN_BRUTE, PILLAGER, RAVAGER, SILVERFISH, SKELETON, SPIDER, STRAY, VINDICATOR, WARDEN, WITCH, WITHER_SKELETON, ENDERMITE -> {
        return startingData;
      }
      case COW, CHICKEN, HOGLIN, OCELOT, PIG, POLAR_BEAR, SNIFFER, ZOGLIN, TURTLE, DROWNED, HUSK, PIGLIN, ZOMBIE, ZOMBIFIED_PIGLIN -> {
